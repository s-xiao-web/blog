...
function DetailsReply() {
  ...
  return (
    <div className={style['reply-wrapper']}>
      <ul className={style['reply-user-info']}>
        <li className={style['reply-item']}>
          <span>邮箱</span>
          <input type="text" />
        </li>
        <li className={style['reply-item']}>
      ...
      <div className={style['reply-text-wrap']}>
        <textarea
          className={style['reply-text']}
          id="veditor"
          placeholder="來都來了不踩一下嗎？"></textarea>
      </div>
      <ul className="reply-review">
        <li>表情</li>
        <li></li>
        <li>预览</li>
      </ul>
      <div className={style['reply-vemojis']}>
